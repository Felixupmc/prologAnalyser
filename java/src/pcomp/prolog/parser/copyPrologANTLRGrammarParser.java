...
public class PrologANTLRGrammarParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, T__3=4, T__4=5, T__5=6, ATOM=7, VAR=8, LINE_COMMENT=9, 
		COMMENT=10, SPACE=11;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, null, null, null, "ATOM", "VAR", "LINE_COMMENT", 
			"COMMENT", "SPACE"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (_la==T__3 || _la==ATOM) {
				{
				{
				setState(8);
				((ProgramContext)_localctx).clause = clause();
	...
	public final ClauseContext clause() throws RecognitionException {
		...
		try {
			...
			case ATOM:
				...
				{
				setState(16);
				((AssertionContext)_localctx).head = predicate();
				setState(26);
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (_la==T__0) {
					...
					match(T__0);
					setState(18);
					((AssertionContext)_localctx).predicate = predicate();
			...
			case T__3:
				...
				{
				setState(30);
				((GoalContext)_localctx).start = match(T__3);
				setState(31);
				((GoalContext)_localctx).predicate = predicate();
	...
	public final PredicateContext predicate() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				{
				setState(43);
				((AtomContext)_localctx).atom = match(ATOM);
				}
				break;
			case 2:
				...
				{
				setState(44);
				((StructureContext)_localctx).atom = match(ATOM);
				setState(45);
				match(T__4);
				{
				setState(54);
				...
				if (_la==ATOM || _la==VAR) {
					{
					setState(46);
					((StructureContext)_localctx).term = term();
	...
	public final TermContext term() throws RecognitionException {
		...
		try {
			...
			case ATOM:
				...
				{
				setState(60);
				((PredContext)_localctx).pred = predicate();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public static final String _serializedATN =
		...
		"\2\2\6\2\4\6\b\2\2\2F\2\r\3\2\2\2\4+\3\2\2\2\6;\3\2\2\2\b?\3\2\2\2\n\f"+
		"\5\4\3\2\13\n\3\2\2\2\f\17\3\2\2\2\r\13\3\2\2\2\r\16\3\2\2\2\16\20\3\2"+
		"\2\2\17\r\3\2\2\2\20\21\7\2\2\3\21\3\3\2\2\2\22\34\5\6\4\2\23\24\7\3\2"+
		"\2\24\31\5\6\4\2\25\26\7\4\2\2\26\30\5\6\4\2\27\25\3\2\2\2\30\33\3\2\2"+
		"\2\31\27\3\2\2\2\31\32\3\2\2\2\32\35\3\2\2\2\33\31\3\2\2\2\34\23\3\2\2"+
		"\2\34\35\3\2\2\2\35\36\3\2\2\2\36\37\7\5\2\2\37,\3\2\2\2 !\7\6\2\2!&\5"+
		"\6\4\2\"#\7\4\2\2#%\5\6\4\2$\"\3\2\2\2%(\3\2\2\2&$\3\2\2\2&\'\3\2\2\2"+
		"\')\3\2\2\2(&\3\2\2\2)*\7\5\2\2*,\3\2\2\2+\22\3\2\2\2+ \3\2\2\2,\5\3\2"+
		"\2\2-<\7\t\2\2./\7\t\2\2/8\7\7\2\2\60\65\5\b\5\2\61\62\7\4\2\2\62\64\5"+
		"\b\5\2\63\61\3\2\2\2\64\67\3\2\2\2\65\63\3\2\2\2\65\66\3\2\2\2\669\3\2"+
		"\2\2\67\65\3\2\2\28\60\3\2\2\289\3\2\2\29:\3\2\2\2:<\7\b\2\2;-\3\2\2\2"+
